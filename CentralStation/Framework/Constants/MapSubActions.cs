...
internal class MapSubActions
{
    ...
    /// <summary>The sub-action which opens a destination menu through the main Central Station ticket booth, with a rare chance of showing a message first.</summary>
    public const string TicketBooth = "TicketBooth";

    /// <summary>The sub-action which opens a destination menu through the main Central Station ticket machine, with a rare chance of showing a message first.</summary>
